...
#define BASE_GPIO_PCA9532 98
#define GPIO_PCA9532_JOY0			(BASE_GPIO_PCA9532+0)
#define GPIO_PCA9532_JOY1			(BASE_GPIO_PCA9532+1)
#define GPIO_PCA9532_JOY2			(BASE_GPIO_PCA9532+2)
#define GPIO_PCA9532_JOY3			(BASE_GPIO_PCA9532+3)
#define GPIO_PCA9532_JOY4			(BASE_GPIO_PCA9532+4)
#define GPIO_PCA9532_OTP			(BASE_GPIO_PCA9532+5)
#define GPIO_PCA9532_USBPWR		(BASE_GPIO_PCA9532+6)
#define GPIO_PCA9532_PWRCTRL	(BASE_GPIO_PCA9532+7)

#define BASE_GPIO_EXTRA				(BASE_GPIO_PCA9532+16)

#define ARCH_NR_GPIOS	(BASE_GPIO_EXTRA + 32)  //allow <=32 extra GPIOS
